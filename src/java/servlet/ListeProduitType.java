 ...
 * @author Haendel
 */
public class ListeProduitType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector listype=type.selectV(connex.getConnexion());
        TypeProduit[] types=new TypeProduit[listype.size()];
        listype.copyInto(types);
