...
"    qi.ingredient,\n" +
"    qi.nom,\n" +
"    sum((qi.prix-qui.prix)*(qui.quantite-qi.quantite)/1000) prix,\n" +
"	sum(qui.quantite-qi.quantite) quantite,\n" +
...
"    qi.ingredient,qi.nom";
            ...
            {
                if(listIngred[i].getQuantite()<0)
                {
                    listIngred[i].setQuantite(0);
                }
                if(listIngred[i].getPrix()<0)
                {
                    listIngred[i].setPrix(0);
                }
            }
